...
%             yticks([1:obj.size(2)])
        ...
        function draw_cells(obj,iter,cells,startpop,dead)
            ...
            title(sprintf("Iter: %i    Start pop: %i\n Healthy: %i    Recovered: %i\n Infected: %i    Sick: %i    Dead: %i",iter,startpop,healthy,recovered,infected,sick,dead))
            hold off
        end
